...
Command injection, exfil via curl:
...
Bruteforce secret_key, forge token with admin user:
...
Leet decode alert using https://www.dcode.fr/leet-speak-1337
...
Search for NTP packets, the flag is exfiltrated using SRC PORT
