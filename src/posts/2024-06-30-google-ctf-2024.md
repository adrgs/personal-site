...
Pretty happy I managed to get 1st blood on both of these challenges. I really liked the hackceler8 game (tldr it's a 2d platformer / 2d top-down depending on the level). In this chall the flag was between 2 moving platforms and we had to glitch ourselves in order to get it. We used our tooling from last year, but if you want to try yourself, [C4T-BuT-S4D has some great open source tooling](https://github.com/C4T-BuT-S4D/hackceler8-2023).
